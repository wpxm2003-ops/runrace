...
export const translations = {
  ...
  es: {
    ...
    privacy_s1_item2: "Nombre y foto de perfil (de tu cuenta de Google / Kakao)",
  ...
  ja: {
    ...
    privacy_s1_item2: "プロフィール名と写真（Google / Kakaoアカウント情報）",
  ...
  zh: {
    ...
    privacy_s1_item2: "个人资料名称和照片（来自 Google / Kakao 账号）",
