...
export const translations = {
  ko: {
    ...
    comparison_pace_faster: (sec: number, unit: string, pct: number) => `▲ ${sec}초/${unit} 빠름 · ${pct}% 향상`,
    comparison_pace_slower: (sec: number, unit: string, pct: number) => `▼ ${sec}초/${unit} 느림 · ${pct}% 감소`,
    comparison_dist_more: (d: string, pct: number) => `+${d} 더 · ${pct}% 증가`,
    comparison_dist_less: (d: string, pct: number) => `-${d} 덜 · ${pct}% 감소`,
    my_unit_label: "거리 단위",
    unit_km: "킬로미터 (km)",
    unit_mi: "마일 (mi)",
  ...
  en: {
    ...
    comparison_pace_faster: (sec: number, unit: string, pct: number) => `▲ ${sec}s/${unit} faster · ${pct}% better`,
    comparison_pace_slower: (sec: number, unit: string, pct: number) => `▼ ${sec}s/${unit} slower · ${pct}% worse`,
    comparison_dist_more: (d: string, pct: number) => `+${d} more · ${pct}%`,
    comparison_dist_less: (d: string, pct: number) => `-${d} less · ${pct}%`,
  ...
  es: {
    ...
    comparison_pace_faster: (sec: number, unit: string, pct: number) => `▲ ${sec}s/${unit} más rápido · ${pct}% mejor`,
    comparison_pace_slower: (sec: number, unit: string, pct: number) => `▼ ${sec}s/${unit} más lento · ${pct}% peor`,
    comparison_dist_more: (d: string, pct: number) => `+${d} más · ${pct}%`,
    comparison_dist_less: (d: string, pct: number) => `-${d} menos · ${pct}%`,
  ...
  ja: {
    ...
    comparison_pace_faster: (sec: number, unit: string, pct: number) => `▲ ${sec}秒/${unit}速い · ${pct}%改善`,
    comparison_pace_slower: (sec: number, unit: string, pct: number) => `▼ ${sec}秒/${unit}遅い · ${pct}%低下`,
    comparison_dist_more: (d: string, pct: number) => `+${d} 多い · ${pct}%増`,
    comparison_dist_less: (d: string, pct: number) => `-${d} 少ない · ${pct}%減`,
    my_unit_label: "距離の単位",
    unit_km: "キロメートル (km)",
    unit_mi: "マイル (mi)",
  ...
  zh: {
    ...
    comparison_pace_faster: (sec: number, unit: string, pct: number) => `▲ 快${sec}秒/${unit} · 提升${pct}%`,
    comparison_pace_slower: (sec: number, unit: string, pct: number) => `▼ 慢${sec}秒/${unit} · 下降${pct}%`,
    comparison_dist_more: (d: string, pct: number) => `+${d} 更多 · 增加${pct}%`,
    comparison_dist_less: (d: string, pct: number) => `-${d} 更少 · 减少${pct}%`,
    my_unit_label: "距离单位",
    unit_km: "公里 (km)",
    unit_mi: "英里 (mi)",
